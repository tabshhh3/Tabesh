            ...
            <?php if (!empty($orders)): ?>
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo number_format($order->total_price); ?> <?php esc_html_e('تومان', 'tabesh'); ?></td>
                        <td><?php echo esc_html(date_i18n('Y/m/d', strtotime($order->created_at))); ?></td>
                        <td><?php echo $order->archived_at ? esc_html(date_i18n('Y/m/d', strtotime($order->archived_at))) : '—'; ?></td>
                        <td>
                            <a href="<?php echo esc_url(wp_nonce_url(admin_url('admin.php?page=tabesh-cancelled&action=restore&order_id=' . $order->id), 'restore_order_' . $order->id)); ?>" 
