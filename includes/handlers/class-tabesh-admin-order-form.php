...
class Tabesh_Admin_Order_Form {
	...
	/**
	 * REST API: Get form configuration
	 * دریافت تنظیمات فرم برای React
	 *
	 * @param WP_REST_Request $request Request object.
	 * @return WP_REST_Response Response object.
	 */
	public function rest_get_form_config( $request ) {
		// Get settings
		$book_sizes          = Tabesh()->get_setting( 'book_sizes', array() );
		$paper_types         = Tabesh()->get_setting( 'paper_types', array() );
		$print_types         = Tabesh()->get_setting( 'print_types', array() );
		...
		$min_quantity  = intval( Tabesh()->get_setting( 'min_quantity', 10 ) );
		$max_quantity  = intval( Tabesh()->get_setting( 'max_quantity', 10000 ) );
		$quantity_step = intval( Tabesh()->get_setting( 'quantity_step', 10 ) );
		...
		return new WP_REST_Response(
			array(
				...
				'data'    => array(
					...
					'cover_paper_weights' => $cover_paper_weights,
